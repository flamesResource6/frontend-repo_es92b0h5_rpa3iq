export default function WhyChooseUs() {
  ...
  return (
    <section id="about" className="py-16 lg:py-24 bg-gradient-to-b from-white via-emerald-50/50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <a href="#services" className="inline-flex items-center rounded-md bg-gradient-to-r from-emerald-600 to-sky-600 px-4 py-2 text-white font-medium shadow hover:shadow-md transition">Read more</a>
          </div>
          <ul className="grid gap-4">
            {items.map((it, idx) => (
              <li key={idx} className="bg-white p-5 rounded-xl border border-slate-200/70 shadow-sm hover:shadow-md transition">
